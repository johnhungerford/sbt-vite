...
//					val dependencies = (Test / npmDependencies).value.toMap
//					val devDependencies = (Test / npmDevDependencies).value.toMap
//					val execDirectory = (Test / viteProdExecutionDirectory).value
...
////				val linkOutputDir = (Compile / fastLinkJS / scalaJSLinkerOutputDirectory)
////				  .value.toPath
////				  .toAbsolutePath
...
//			val sources = (Test / fastLinkJS / scalaJSLinkerOutputDirectory)
//			  .value +: {
//				(Test / viteOtherSources)
//				  .value
//				  .toList
...
//		vitePrepareProdSources := {
//			if (
//				(Test / vitePrepareProdSources).inputFileChanges.hasChanges
//			)
//			(Test / viteDependencyManagement).value match {
//				case DependencyManagement.Manual => {}
...
//					  .map(_.resolve(file("."), baseDirectory.value))
//
//					val target = (Test / viteProdExecutionDirectory).value
//
...
//					}
//
//					val scalajsSource = (Test / fastLinkJS / scalaJSLinkerOutputDirectory)
//				  		.value
//					val scalajsTarget = (Test / viteProdExecutionDirectory).value / "__scalajs"
//
//					injector.inject(Seq(scalajsSource), scalajsTarget) match {
//						case Right(_) => {}
//						case Left(msg) =>
//							throw new MessageOnlyException(msg)
//					}
...
//		},
//
//		vitePrepareProdSources := (Test / vitePrepareProdSources)
//		  .dependsOn(Test / fastLinkJS).value,
//
//		viteBuildProd / fileInputs ++= Seq(
//			(Test / viteProdConfigLocation)
//			  .value
//			  .resolve(file("."), baseDirectory.value)
//			  .toString,
//			(Test / fastLinkJS / scalaJSLinkerOutputDirectory).value.toPath.toString + "/*.js",
//			(Test / viteProdExecutionDirectory).value.absolutePath.stripSuffix("/") + "/package*.json",
//		),
//
//		viteBuildProd := {
...
//			if ( {
//				(Test / viteBuildProd).inputFileChanges.hasChanges
//			} || {
//				Try(IO
//				  .read(
//					  (Test / viteProdBundleLocation).value
//													 .resolve(file("."), baseDirectory.value)
//				  ),
//				).isFailure
//			}) {
//				val configPath = (Test / viteProdConfigLocation)
//				  .value
//				  .resolve(file("."), baseDirectory.value)
//				  .toPath
//				  .toString
//				val viteCwd = (Test / viteProdExecutionDirectory)
//				  .value
...
//		},
//
//		viteBuildProd := (Test / viteBuildProd)
//		  .dependsOn(
//			  Test / viteGenerateConfig,
//			  Test / viteInstallDependencies,
//			  Test / vitePrepareProdSources,
//			  Test / fastLinkJS,
//		  )
//		  .value,
//
//		Test / test := (Test / test).dependsOn(Test / viteBuildProd).value,
//	)
...
//
//		viteProdBundleLocation := Location.FromCwd(
//			viteProdBundleDirectory.value / bundleFilename.value,
//		),
//
...
//
//		viteProdConfigLocation := Location.FromCwd(
//			viteProdTargetDirectory.value / viteConfigName.value,
//		),
//
//		viteProdConfigSources := viteProdConfigSources.value,
//
	...
	override lazy val projectSettings = Seq(
		...
		viteInstallDependenciesDev := {
			viteDependencyManagement.value match {
				case DependencyManagement.Manual => {}
				case DependencyManagement.InstallOnly(manager) =>
					viteInstallDependenciesProd.value
